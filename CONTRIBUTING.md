...
The STPhotoCollection maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/mikelanza/st-photo-collection-ios/blob/master/CODE_OF_CONDUCT.md) for details.
